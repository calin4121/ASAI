...
import Supplier from "./ERP/supplier/index";
  ...
  return (
    <Router>
      <Switch>
        ...
        ></Route>
        <Route
          path="/performance/clients"
          exact
          component={() => <Clients />}
        ></Route>
        <Route
          path="/performance/service_types"
          exact
          component={() => <ServiceTypes />}
        ></Route>
        <Route
          path="/performance/new_client"
          exact
          component={() => <NewClient />}
        ></Route>
        <Route
          path="/performance/new_feedback/:id"
          exact
          component={() => <NewFeedback />}
        ></Route>
        <Route
          path="/performance/new_service"
          exact
          component={() => <NewService />}
        ></Route>
        <Route
          path="/performance/new_service_type"
          exact
